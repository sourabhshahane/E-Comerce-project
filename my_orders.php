...
<head>
    ...
    <title>My Orders | ShopBOX</title>
    <link rel="stylesheet" type="text/css" href="css/style.css">
    <link rel="icon" type="image/ico" href="icons/logo_orders_checklist.png">
...
<nav class="navbar navbar-inverse">
    ...
    if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true)
    {
        ...
        $qury = "SELECT * FROM e_commerce_products INNER JOIN orders ON e_commerce_products.Product_id=orders.p_id AND orders.u_id=?";

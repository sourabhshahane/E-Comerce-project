...
<html>  	
    <head>  
        <title>Baby Bath & Hygiene | ShopBox</title>
    ...
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <h3>All products with category: Baby Bath & Hygiene</h3>
        <br>
        <?php
        $qury = "SELECT * FROM `e_commerce_products` WHERE Category = 'Baby Bath & Hygiene' ORDER BY Product_id ASC";

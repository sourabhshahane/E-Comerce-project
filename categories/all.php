...
<html>  	
    <head>  
        <title>All Purpose Cleaners | ShopBox</title>
    ...
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <h3>All products with category: All Purpose Cleaners</h3>
        <br>
        <?php
        $qury = "SELECT * FROM `e_commerce_products` WHERE Category = 'All Purpose Cleaners' ORDER BY Product_id ASC";

...
<html>  	
    <head>  
        <title>Chips,Namkeen & Snacks | ShopBox</title>
    ...
    <div class="container-fluid">
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <h3>All products with category: Chips,Namkeen & Snacks</h3>
        <br>
        <?php
        $qury = "SELECT * FROM `e_commerce_products` WHERE Category = 'Chips,Namkeen & Snacks' ORDER BY Product_id ASC";
